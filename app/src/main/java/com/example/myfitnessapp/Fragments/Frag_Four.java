...
public class Frag_Four extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_frag__four,container,false);
        recyclerViewBazarRewards = v.findViewById(R.id.rvFragmentFour);
    ...
    private void getDataFromFireStore(Query query) {
        ...
        FirestorePagingOptions<RewardsModel> options = new FirestorePagingOptions.Builder<RewardsModel>()
                .setLifecycleOwner(Frag_Four.this)
